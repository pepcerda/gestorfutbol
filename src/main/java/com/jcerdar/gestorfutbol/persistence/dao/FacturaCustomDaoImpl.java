...
@Repository
public class FacturaCustomDaoImpl implements FacturaCustomDao{

    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public Page<Factura> buscarConFiltros(Filtre filtre) {
        ...
        List<Factura> resultList = typedQuery.getResultList();
    ...
    @Override
    public List<Factura> buscarConFiltrosAll(Filtre filtre) {
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
    ...
    private List<Predicate> construirPredicats(Filtre filtre, Root<Factura> root, CriteriaBuilder cb) {
