...
@Repository
public class CategoriaDespesaCustomDaoImpl implements CategoriaDespesaCustomDao{

    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public Page<CategoriaDespesa> buscarConFiltros(Filtre filtre) {
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();

        // MAIN QUERY
        CriteriaQuery<CategoriaDespesa> query = cb.createQuery(CategoriaDespesa.class);
        Root<CategoriaDespesa> root = query.from(CategoriaDespesa.class);
        ...
        TypedQuery<CategoriaDespesa> typedQuery = entityManager.createQuery(query);
        ...
        List<CategoriaDespesa> resultList = typedQuery.getResultList();

        // COUNT QUERY
        CriteriaQuery<Long> countQuery = cb.createQuery(Long.class);
        Root<CategoriaDespesa> countRoot = countQuery.from(CategoriaDespesa.class);
    ...
    @Override
    public List<CategoriaDespesa> buscarConFiltrosAll(Filtre filtre) {
        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
