...
public class PatrocinadorFactory {
    public static List<PatrocinadorDTO> getPatrocinadores() {
        ...
        patrocinadores.add(new PatrocinadorDTO(1L, 101L, "CIF123", "Patrocinador 1", 1000L, new Date(), "", null));
        patrocinadores.add(new PatrocinadorDTO(2L, 102L, "CIF456", "Patrocinador 2", 2000L, new Date(), "", null));
