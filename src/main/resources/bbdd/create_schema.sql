...
ALTER TABLE GF_CONTACTEPROV
    ADD CONSTRAINT FK_GF_CONTACTEPROV_ON_CPR_MEM FOREIGN KEY (CPR_MEM) REFERENCES GF_MEMPLANT (MEM_ID);
...
ALTER TABLE GF_JUGADOR
    ADD CONSTRAINT FK_GF_JUGADOR_ON_JUG_POSICIO FOREIGN KEY (JUG_POSICIO) REFERENCES GF_POS_JUGADOR (POS_ID);
