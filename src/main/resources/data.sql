INSERT INTO GF_ROL_USUARI_TENANT (ROL_NOM)
VALUES ('ADMINISTRADOR');

INSERT INTO GF_ROL_USUARI_TENANT (ROL_NOM)
VALUES ('COLABORADOR');

INSERT INTO GF_PLA_SUSCRIPCIO (PLA_TIPUS, PLA_CUOTA)
VALUES ('BASIC', 9.99);
...
-- SUPERADMIN
INSERT INTO GF_USUARI (USU_PROVID,
                       USU_SUPERADMIN,
                       USU_NOM,
                       USU_COGNOMS,
                       USU_EMAIL)
VALUES ('kp_601dc5f9ec944428aa3708faf30c3dfe',
        true,
        'Josep',
        'Cerda Roscar',
        'josep.cerda.roscar@gmail.com');

INSERT INTO GF_USUARI_TENANT (UT_USU_ID,
                              UT_TEN_ID,
                              UT_ROL,
                              UT_ACTIU)
VALUES (1, 1, 1, true);

INSERT INTO GF_ROLDIR (RDI_TEN, RDI_ROL)
VALUES (1, 'President');
...
INSERT INTO GF_CONFIG (CONF_TEN,
                       CONF_CIF,
                       CONF_NOM,
                       CONF_COL,
                       CONF_CLF1,
...
INSERT INTO GF_CAMPANYA (CAM_TEN, CAM_ANY, CAM_TITOL)
VALUES (1,
        '2025-01-01',
        'Temporada 2025-2026');
...
INSERT INTO GF_MENSUALITAT (MEN_ANY,
                            MEN_MES,
                            MEN_CAM,
                            MEN_EQP)
VALUES (2025, 12, 1, 1);
...
INSERT INTO GF_POS_JUGADOR (POS_TEN, POS_NOM)
VALUES (1, 'PORTER');
...
INSERT INTO GF_MEMPLANT (MEM_CAM,
                         MEM_EQP,
                         MEM_NOM,
                         MEM_LLIN1,
                         MEM_LLIN2,
...
INSERT INTO GF_QUOTA_JUGADOR (QUO_JUG,
                              QUO_ESTAT,
                              QUO_EXEP,
                              QUO_QUANT)
VALUES ((
...
-- Plantilla HTML
INSERT INTO GF_PLANTILLA_DOCUMENTO (PLA_TEN,
                                    PLA_COD,
                                    PLA_NOM,
                                    PLA_IDI,
                                    PLA_HTML,
